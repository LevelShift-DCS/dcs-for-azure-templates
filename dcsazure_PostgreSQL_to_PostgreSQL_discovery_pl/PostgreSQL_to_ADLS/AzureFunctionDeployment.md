...
- PostgreSQL_to_ADLS ZIP file containing the Azure Function App code and configuration
...
* `resource-group` : The Azure resource group that contains the PostgreSQL_to_ADLS Azure Function App
* `name` : The name of the PostgreSQL_to_ADLS Azure Function App
* `src` : The full path to the PostgreSQL_to_ADLS ZIP package containing the Function App code
