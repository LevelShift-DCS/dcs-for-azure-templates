...
- ADLS_to_PostgreSQL ZIP file containing the Azure Function App code and configuration
...
* `resource-group` : The Azure resource group that contains the ADLS_to_PostgreSQL Azure Function App
* `name` : The name of the ADLS_to_PostgreSQL Azure Function App
* `src` : The full path to the ADLS_to_PostgreSQL ZIP package containing the Function App code
